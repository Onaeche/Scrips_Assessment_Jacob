...
namespace dotnet_api_cqrs.tests
{
	public class TestDbContext : DbContext
	{
        ...
        public override int UpdatePerson(string sql, object param = null, CommandType commandType = CommandType.Text, IDbTransaction transaction = null, int? timeout = null)
		{
			_isQuery = false;
			return base.UpdatePerson(sql, param, commandType, transaction, timeout);
		}
